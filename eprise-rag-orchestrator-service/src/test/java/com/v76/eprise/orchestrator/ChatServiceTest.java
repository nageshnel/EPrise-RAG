...
class ChatServiceTest {
    ...
    void chat_validRequest_returnsAnswerWithSources() {
        ...
        com.v76.eprise.orchestrator.ChatResponse response = chatService.chat(UUID.randomUUID(), request);
    ...
    void chat_nullRetrievalResponse_returnsEmptySourceList() {
        ...
        com.v76.eprise.orchestrator.ChatResponse response = chatService.chat(UUID.randomUUID(), new ChatRequest("?", null));
    ...
    void chat_sourceCitationsContainMetadata() {
        ...
        com.v76.eprise.orchestrator.ChatResponse response = chatService.chat(UUID.randomUUID(), new ChatRequest("q", null));
